        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('firm_name') ? 'is-invalid' : '' }}" type="text"
                        name="firm_name" id="firm_name" value="{{ old('firm_name', $setting->firm_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('open_work') ? 'is-invalid' : '' }}" type="text"
                        name="open_work" id="open_work" value="{{ old('open_work', $setting->open_work) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('firm_logo') ? 'is-invalid' : '' }}"
                        id="firm_logo-dropzone">
                    </div>
                ...
                <div class="form-group">
                    <label for="default_image">{{ trans('cruds.setting.fields.default_image') }}</label>
                    <div class="needsclick dropzone {{ $errors->has('default_image') ? 'is-invalid' : '' }}"
                        id="default_image-dropzone">
                    </div>
                    ...
                    @endif
                    <span class="help-block">{{ trans('cruds.setting.fields.default_image_helper') }}</span>
                </div>
                <div class="form-group">
...
@section('scripts')
    <script>
        Dropzone.options.defaultImageDropzone = {
            ...
            success: function(file, response) {
                $('form').find('input[name="default_image"]').remove()
                $('form').append('<input type="hidden" name="default_image" value="' + response.name + '">')
            },
            ...
            init: function() {
                @if (isset($setting) && $setting->default_image)
                    var file = {!! json_encode($setting->default_image) !!}
                    this.options.addedfile.call(this, file)
                    this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
                    file.previewElement.classList.add('dz-complete')
                    $('form').append('<input type="hidden" name="default_image" value="' + file.file_name + '">')
                    this.options.maxFiles = this.options.maxFiles - 1
                @endif
            },
